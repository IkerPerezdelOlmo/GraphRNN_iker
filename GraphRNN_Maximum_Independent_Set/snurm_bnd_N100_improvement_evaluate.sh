...
#SBATCH --job-name=Proba
#SBATCH --output=./emaitzak/ZProba_eval_%A_%a.txt
#SBATCH --error=./emaitzak/ZProba_eval_%A_%a_error.txt
...
DATASETS=('Internet_Topology_500_N100_skitter' 'USA-road_d_500_N100_NY' 'random_erdos-renyi_500_M100_P3')
