...
#SBATCH --job-name=road_all_comb
#SBATCH --output=./emaitzak/road_all_comb_%A_%a.txt
#SBATCH --error=./emaitzak/road_all_comb_%A_%a_error.txt
...
DATASETS=('USA-road_d_5_N2_NY' 'USA-road_d_5_N10_NY' 'USA-road_d_5_N40_NY' 'USA-road_d_5_N100_NY' 'USA-road_d_5_N200_NY' 'USA-road_d_15_N200_NY' 'USA-road_d_50_N200_NY' 'USA-road_d_150_N200_NY' 'USA-road_d_500_N100_NY' 'USA-road_d_500_N200_NY')
LEARNING_RATE=(0.003)
SEED=(1 2)
MODEL_SIZE=(1)
