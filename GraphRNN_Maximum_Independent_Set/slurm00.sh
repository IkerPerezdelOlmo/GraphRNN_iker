...
#SBATCH --output=/scratch/ikperez/GraphRNN_MIS/GraphRNN_Maximum_Independent_Set/GraphRNN_MIS_P3_500_N9_5000_%j.txt
#SBATCH --error=/scratch/ikperez/GraphRNN_MIS/GraphRNN_Maximum_Independent_Set/GraphRNN_MIS_P3_500_N9_5000_%j_error.txt
