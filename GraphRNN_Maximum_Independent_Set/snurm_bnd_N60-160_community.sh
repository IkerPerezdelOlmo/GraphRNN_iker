...
#SBATCH --job-name=comunity_60
#SBATCH --output=./emaitzak/comunity_60_%A_%a.txt
#SBATCH --error=./emaitzak/comunity_60_%A_%a_error.txt
...
DATASETS=('random_Community_500_M160_P3')
LEARNING_RATE=(0.001)
SEED=(1 12 35 420 555 6)
MODEL_SIZE=(1)
